...
class BridgeStore(AdminAuditMixin):
    def __init__(
        self,
        database: str | Path,
        *,
    ...
    def preview_history_redaction(
        ...
        *,
        ...
        with self._transaction() as conn:
            ...
            if not candidates:
                raise ConflictError("no messages currently match the retention policy")
    ...
    def execute_history_redaction(
        ...
        *,
        ...
        with self._transaction() as conn:
            ...
            if preview is None:
                raise NotFoundError("history redaction preview was not found")
            ...
            if preview["consumed_at"] is not None:
                raise ConflictError("history redaction preview was already used")
            if float(preview["expires_at"]) <= now:
                raise ConflictError("history redaction preview has expired")
