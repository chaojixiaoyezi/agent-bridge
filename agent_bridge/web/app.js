...
const elements = {
  ...
  toggleTopbarPanel: document.querySelector("#toggle-topbar-panel"),
  ...
  layoutToggleTopbar: document.querySelector("#layout-toggle-topbar"),
  layoutTopbarStatus: document.querySelector("#layout-topbar-status"),
  layoutDensitySimple: document.querySelector("#layout-density-simple"),
  layoutDensityStandard: document.querySelector("#layout-density-standard"),
  ...
  newRoomKinds: [...document.querySelectorAll('input[name="room_kind"]')],
  ...
  agentAccessPolicyHelp: document.querySelector("#agent-access-policy-help"),
